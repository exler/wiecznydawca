        ...
        <>
            {
                !chosenJournalKind ? (
                    <div className="flex w-full flex-col lg:flex-row mx-auto justify-center items-center gap-y-4">
                        <div onClick={() => setChosenJournalKind(JournalKind.DONATION)} className="card w-3/4 lg:w-96 bg-base-100 shadow-xl mr-4 cursor-pointer">
                        ...
                        <div onClick={() => setChosenJournalKind(JournalKind.DISQUALIFICATION)} className="card w-3/4 lg:w-96 bg-base-100 shadow-xl cursor-pointer">
                            <figure className="px-10 pt-10">
